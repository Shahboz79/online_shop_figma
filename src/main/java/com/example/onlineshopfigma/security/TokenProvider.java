...
public class TokenProvider {
    ...
    private long tokenValidateMilisecondRemember;
    private long getTokenValidateMilisecond;
    ...
    public TokenProvider(){
        ...
        this.tokenValidateMilisecondRemember=1000*86400;
        this.getTokenValidateMilisecond=1000*3600;
    ...
    public String createToken(Authentication authentication, boolean rememberMe) {
        ...
        Date validate;
        if (rememberMe){
            validate=new Date(now +tokenValidateMilisecondRemember);
        }else {
            validate=new Date(now+getTokenValidateMilisecond);
        }
        return Jwts.builder()
